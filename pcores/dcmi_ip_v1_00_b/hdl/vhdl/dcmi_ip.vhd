------------------------------------------------------------------------------
-- dcmi_ip.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use dcmi_ip_v1_00_b.user_logic;
...
architecture IMP of dcmi_ip is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity dcmi_ip_v1_00_b.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "001" => ipif_IP2Bus_Data <= (others => '0');
